package com.commonslab.commonslab.VideoRecording;
...
public class Camera2VideoFragment extends Fragment
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            manager.openCamera(cameraId, mStateCallback, null);//permission already required before we come here
    ...
    private String getVideoFilePath(Context context) {
        return context.getExternalFilesDir(null).getAbsolutePath() + "/"
                + "Commons_video_" + System.currentTimeMillis() + ".webm";
    }
...
//        startPreview();
    ...
    private void loadUploadSceen() {

        //Close this fragment
        getActivity().getFragmentManager()
                .beginTransaction()
                .remove(Camera2VideoFragment.this)
                .commit();

        ((MainActivity) getActivity()).loadUploadScreen(mNextVideoAbsolutePath);
    }
